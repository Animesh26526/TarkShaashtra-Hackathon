...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!userId || !secret) {
      return setError('Invalid password reset link. Please check your link or request a new one.');
    }
        ...
        {!success ? (
          ...
          <div className="recovery-success">
            ...
            <p className="success-message">
              Your password has been successfully updated. You may now return to the portal and sign in.
            </p>
