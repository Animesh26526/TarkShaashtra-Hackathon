          ...
          >
            ...
            <div className="type-selection-grid">
              ...
              <ComplaintTypeCard 
                title="Agentic Mode" 
                icon={Bot} 
                description="Speak your issue. AI autonomously resolves it and generates a visual guide."
                onClick={() => handleTypeSelect('Agentic')}
                active={selectedType === 'Agentic'}
              />
            </div>
          </motion.div>
        )}
        ...
        {step === 'details' && (
          ...
          >
            ...
            {selectedType === 'Agentic' && (
              <AgenticMode 
                onContinueAsText={(data) => {
                  setTextData({ title: data.title || '', description: data.description || '' });
