                ...
                <tr key={c.id}>
                  ...
                  <td>
                    <div className="agent-cell">
                      <div className="agent-avatar">{c.assignedTo.charAt(0)}</div>
                      <span>{c.assignedTo}</span>
                    </div>
                  </td>
                  <td>
                    <p className="date-text">{new Date(c.createdAt).toLocaleDateString()}</p>
                  </td>
                  <td>
                    <Link to={`/complaints/${c.id}`} className="action-btn">
