...
const Sidebar = () => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/', icon: BarChart3, roles: ['Operations Manager'] },
    { name: 'Complaints', path: '/complaints', icon: MessageSquare, roles: ['Operations Manager', 'Support Executive', 'QA Team'] },
    { name: 'New Complaint', path: '/submit', icon: PlusCircle, roles: ['Customer'] },
    { name: 'My History', path: '/history', icon: FileText, roles: ['Customer'] },
